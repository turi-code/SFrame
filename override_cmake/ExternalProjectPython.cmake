...
if (APPLE)
  target_link_libraries(python INTERFACE ${CMAKE_SOURCE_DIR}/deps/local/lib/${CMAKE_SHARED_LIBRARY_PREFIX}${PYTHON_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX} z)
elseif(WIN32)
  ...
  target_link_libraries(python INTERFACE ${CMAKE_SOURCE_DIR}/deps/local/lib/${CMAKE_SHARED_LIBRARY_PREFIX}${PYTHON_VERSION}${CMAKE_SHARED_LIBRARY_SUFFIX} z rt)
endif()
target_compile_definitions(python INTERFACE HAS_PYTHON)
target_include_directories(python INTERFACE ${CMAKE_SOURCE_DIR}/deps/local/include/${PYTHON_VERSION})
...
target_include_directories(python_header_only INTERFACE ${CMAKE_SOURCE_DIR}/deps/local/include/${PYTHON_VERSION})
