 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_MANAGER_LOGICAL_FILTER_HPP
#define GRAPHLAB_SFRAME_QUERY_MANAGER_LOGICAL_FILTER_HPP
...
#endif // GRAPHLAB_SFRAME_QUERY_MANAGER_LOGICAL_FILTER_HPP
