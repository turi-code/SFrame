 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_MANAGER_SFRAME_SOURCE_HPP
#define GRAPHLAB_SFRAME_QUERY_MANAGER_SFRAME_SOURCE_HPP
...
#endif // GRAPHLAB_SFRAME_QUERY_MANAGER_SFRAME_SOURCE_HPP
