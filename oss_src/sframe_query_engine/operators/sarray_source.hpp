 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_MANAGER_SARRAY_SOURCE_HPP
#define GRAPHLAB_SFRAME_QUERY_MANAGER_SARRAY_SOURCE_HPP
#include <sstream>
...
#endif // GRAPHLAB_SFRAME_QUERY_MANAGER_SARRAY_SOURCE_HPP
