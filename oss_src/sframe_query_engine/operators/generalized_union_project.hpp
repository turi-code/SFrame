 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_MANAGER_GENERALIZED_UNION_PROJECT_NODE_HPP
#define GRAPHLAB_SFRAME_QUERY_MANAGER_GENERALIZED_UNION_PROJECT_NODE_HPP
...
#endif // GRAPHLAB_SFRAME_QUERY_MANAGER_UNION_HPP
