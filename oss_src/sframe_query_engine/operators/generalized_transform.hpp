 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_MANAGER_GENERALIZED_TRANSFORM_HPP
#define GRAPHLAB_SFRAME_QUERY_MANAGER_GENERALIZED_TRANSFORM_HPP
...
#endif // GRAPHLAB_SFRAME_QUERY_MANAGER_TRANSFORM_HPP
