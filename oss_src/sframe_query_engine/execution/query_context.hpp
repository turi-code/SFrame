 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_ENGINE_OPERATORS_QUERY_CONTEXT_HPP
#define GRAPHLAB_SFRAME_QUERY_ENGINE_OPERATORS_QUERY_CONTEXT_HPP
#include <memory>
#include <vector>
...
/**
 * Calling emit(...) returns a state, which informs the
...
#endif // GRAPHLAB_SFRAME_QUERY_ENGINE_OPERATORS_QUERY_CONTEXT_HPP
