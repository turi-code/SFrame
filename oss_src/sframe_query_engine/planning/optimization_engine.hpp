 ...
 */
#ifndef GRAPHLAB_SFRAME_QUERY_OPTIMIZATION_ENGINE_H_
#define GRAPHLAB_SFRAME_QUERY_OPTIMIZATION_ENGINE_H_
...
/** The main engine to power the optimizations.  We'll call it Hamlet
 *  the hypersquirrel.
 *
 */
