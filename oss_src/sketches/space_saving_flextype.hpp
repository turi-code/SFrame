 ...
 */
#ifndef GRAPHLAB_SKETCHES_SPACE_SAVING_SKETCH_FLEXTYPE_HPP
#define GRAPHLAB_SKETCHES_SPACE_SAVING_SKETCH_FLEXTYPE_HPP
...
/** Provides an efficient wrapper around the space_saving sketch customized for use with flexible type 
 *
 */
