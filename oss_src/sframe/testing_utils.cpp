      ...
      for(size_t c_idx = 0; c_idx < column_types.size(); ++c_idx) {
        ...
        switch(column_types[c_idx]){
          ...
          case 'U': {
            ...
            flex_list v(s);
            for(flexible_type& f : v)
              f = rng_int(0,n_categorical_many);
          ...
          case 'd': {
            ...
            for(size_t i = 0; i < dict_size_small; ++i) {
              flexible_type index = rng_int(0, 3*dict_size_small);
              flexible_type value = rng_int(1, 100);
              m[index] = value;
            }
          ...
          case 'D': {
            ...
            for(size_t i = 0; i < dict_size_large; ++i) {
              flexible_type index = rng_int(0, n_categorical_many);
              flexible_type value = rng_int(1, 1000);
              m[index] = value;
            }
