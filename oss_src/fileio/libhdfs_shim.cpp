...
extern  "C" {
  ...
  hdfsFS hdfsConnectAsUser(const char* host, tPort port, const char *user) {
    ...
    if (ptr_hdfsConnectAsUser) return graphlab::run_as_native(ptr_hdfsConnectAsUser,host, port, user); 
    else return NULL;
  }
  ...
  hdfsFS hdfsConnect(const char* host, tPort port) {
    ...
    if (ptr_hdfsConnect) { 
      auto x = graphlab::run_as_native(ptr_hdfsConnect, host, port);
      if (x == NULL) {
  ...
  int hdfsDisconnect(hdfsFS fs)  {
    ...
    if (ptr_hdfsDisconnect) return graphlab::run_as_native(ptr_hdfsDisconnect, fs);
    else return 0;
  }
  ...
  hdfsFile hdfsOpenFile(hdfsFS fs, const char* path, int flags,
    ...
    if (ptr_hdfsOpenFile) return graphlab::run_as_native(ptr_hdfsOpenFile, fs, path, flags, bufferSize, replication, blocksize);
    else return NULL;
  }
  ...
  int hdfsCloseFile(hdfsFS fs, hdfsFile file) {
    ...
    if (ptr_hdfsCloseFile) return graphlab::run_as_native(ptr_hdfsCloseFile, fs, file);
    else return 0;
  }
  ...
  int hdfsExists(hdfsFS fs, const char *path) {
    ...
    if (ptr_hdfsExists) return graphlab::run_as_native(ptr_hdfsExists, fs, path);
    else return 0;
  }
  ...
  int hdfsSeek(hdfsFS fs, hdfsFile file, tOffset desiredPos) {
    ...
    if (ptr_hdfsSeek) return graphlab::run_as_native(ptr_hdfsSeek, fs, file, desiredPos);
    else return 0;
  }
  ...
  tOffset hdfsTell(hdfsFS fs, hdfsFile file) {
    ...
    if (ptr_hdfsTell) return graphlab::run_as_native(ptr_hdfsTell, fs, file);
    else return 0;
  }
  ...
  tSize hdfsRead(hdfsFS fs, hdfsFile file, void* buffer, tSize length) {
    ...
    if (ptr_hdfsRead) return graphlab::run_as_native(ptr_hdfsRead, fs, file, buffer, length);
    else return 0;
  }
  ...
  tSize hdfsPread(hdfsFS fs, hdfsFile file, tOffset position, void* buffer, tSize length) {
    ...
    if (ptr_hdfsPread) return graphlab::run_as_native(ptr_hdfsPread, fs, file, position, buffer, length);
    else return 0;
  }
  ...
  tSize hdfsWrite(hdfsFS fs, hdfsFile file, const void* buffer, tSize length) {
    ...
    if (ptr_hdfsWrite) return graphlab::run_as_native(ptr_hdfsWrite, fs, file, buffer, length);
    else return 0;
  }
  ...
  int hdfsFlush(hdfsFS fs, hdfsFile file) {
    ...
    if (ptr_hdfsFlush) return graphlab::run_as_native(ptr_hdfsFlush, fs, file);
    else return 0;
  }
  ...
  int hdfsAvailable(hdfsFS fs, hdfsFile file) {
    ...
    if (ptr_hdfsAvailable) return graphlab::run_as_native(ptr_hdfsAvailable, fs, file);
    else return 0;
  }
  ...
  int hdfsCopy(hdfsFS srcFS, const char* src, hdfsFS dstFS, const char* dst) {
    ...
    if (ptr_hdfsCopy) return graphlab::run_as_native(ptr_hdfsCopy, srcFS, src, dstFS, dst);
    else return 0;
  }
  ...
  int hdfsMove(hdfsFS srcFS, const char* src, hdfsFS dstFS, const char* dst) {
    ...
    if (ptr_hdfsMove) return graphlab::run_as_native(ptr_hdfsMove, srcFS, src, dstFS, dst);
    else return 0;
  }
  ...
  int hdfsDelete(hdfsFS fs, const char* path, int recursive) {
    ...
    if (ptr_hdfsDelete) return graphlab::run_as_native(ptr_hdfsDelete, fs, path, recursive);
    else return 0;
  }
  ...
  int hdfsRename(hdfsFS fs, const char* oldPath, const char* newPath) {
    ...
    if (ptr_hdfsRename) return graphlab::run_as_native(ptr_hdfsRename, fs, oldPath, newPath);
    else return 0;
  }
  ...
  char* hdfsGetWorkingDirectory(hdfsFS fs, char *buffer, size_t bufferSize) {
    ...
    if (ptr_hdfsGetWorkingDirectory) return graphlab::run_as_native(ptr_hdfsGetWorkingDirectory, fs, buffer, bufferSize);
    else return NULL;
  }
  ...
  int hdfsSetWorkingDirectory(hdfsFS fs, const char* path) {
    ...
    if (ptr_hdfsSetWorkingDirectory) return graphlab::run_as_native(ptr_hdfsSetWorkingDirectory, fs, path);
    else return 0;
  }
  ...
  int hdfsCreateDirectory(hdfsFS fs, const char* path) {
    ...
    if (ptr_hdfsCreateDirectory) return graphlab::run_as_native(ptr_hdfsCreateDirectory, fs, path);
    else return 0;
  }
  ...
  int hdfsSetReplication(hdfsFS fs, const char* path, int16_t replication) {
    ...
    if (ptr_hdfsSetReplication) return graphlab::run_as_native(ptr_hdfsSetReplication, fs, path, replication);
    else return 0;
  }
  ...
  hdfsFileInfo* hdfsListDirectory(hdfsFS fs, const char* path, int *numEntries) {
    ...
    if (ptr_hdfsListDirectory) return graphlab::run_as_native(ptr_hdfsListDirectory, fs, path, numEntries);
    else return NULL;
  }
  ...
  hdfsFileInfo* hdfsGetPathInfo(hdfsFS fs, const char* path) {
    ...
    if (ptr_hdfsGetPathInfo) return graphlab::run_as_native(ptr_hdfsGetPathInfo, fs, path);
    else return 0;
  }
  ...
  void hdfsFreeFileInfo(hdfsFileInfo *hdfsFileInfo, int numEntries) {
    ...
    if (ptr_hdfsFreeFileInfo) graphlab::run_as_native(ptr_hdfsFreeFileInfo, hdfsFileInfo, numEntries);
  }
  ...
  char*** hdfsGetHosts(hdfsFS fs, const char* path, tOffset start, tOffset length) {
    ...
    if (ptr_hdfsGetHosts) return graphlab::run_as_native(ptr_hdfsGetHosts, fs, path, start, length);
    else return NULL;
  }
  ...
  void hdfsFreeHosts(char*** blockHosts) {
    ...
    if (ptr_hdfsFreeHosts) graphlab::run_as_native(ptr_hdfsFreeHosts, blockHosts);
  }


  tOffset hdfsGetDefaultBlockSize(hdfsFS fs) {
    if(!ptr_hdfsGetDefaultBlockSize) *(void**)(&ptr_hdfsGetDefaultBlockSize) = get_symbol("hdfsGetDefaultBlockSize");
    if (ptr_hdfsGetDefaultBlockSize) return graphlab::run_as_native(ptr_hdfsGetDefaultBlockSize, fs);
    else return 0;
  }
  ...
  tOffset hdfsGetCapacity(hdfsFS fs) {
    ...
    if (ptr_hdfsGetCapacity) return graphlab::run_as_native(ptr_hdfsGetCapacity, fs);
    else return 0;
  }
  ...
  tOffset hdfsGetUsed(hdfsFS fs) {
    ...
    if (ptr_hdfsGetUsed) return graphlab::run_as_native(ptr_hdfsGetUsed, fs);
    else return 0;
  }

  int hdfsChown(hdfsFS fs, const char* path, const char *owner, const char *group) {
    if(!ptr_hdfsChown) *(void**)(&ptr_hdfsChown) = get_symbol("hdfsChown");
    if (ptr_hdfsChown) return graphlab::run_as_native(ptr_hdfsChown, fs, path, owner, group);
    else return 0;
  }

  int hdfsChmod(hdfsFS fs, const char* path, short mode) {
    if(!ptr_hdfsChmod) *(void**)(&ptr_hdfsChmod) = get_symbol("hdfsChmod");
    if (ptr_hdfsChmod) return graphlab::run_as_native(ptr_hdfsChmod, fs, path, mode);
    else return 0;
  }

  int hdfsUtime(hdfsFS fs, const char* path, tTime mtime, tTime atime) {
    if(!ptr_hdfsUtime) *(void**)(&ptr_hdfsUtime) = get_symbol("hdfsUtime");
    if (ptr_hdfsUtime) return graphlab::run_as_native(ptr_hdfsUtime, fs, path, mtime, atime);
    else return 0;
  }
