 ...
 */
#ifndef GRAPHLAB_GROUPED_SFRAME_HPP
#define GRAPHLAB_GROUPED_SFRAME_HPP
...
class EXPORT grouped_sframe: public graphlab::toolkit_class_base {
 public:
  /**
...
#endif // GRAPHLAB_GROUPED_SFRAME_HPP
