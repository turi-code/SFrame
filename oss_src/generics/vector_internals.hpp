 ...
 */
#ifndef GRAPHLAB_GL_VECTOR_INTERNALS_H_
#define GRAPHLAB_GL_VECTOR_INTERNALS_H_
...
namespace graphlab { namespace gl_vector_internal {
...
#endif /* GRAPHLAB_VECTOR_INTERNALS_H_ */
