 ...
 */
#ifndef GRAPHLAB_GL_VECTOR_H_
#define GRAPHLAB_GL_VECTOR_H_
...
template <class T>
inline void swap (graphlab::gl_vector<T>& a, graphlab::gl_vector<T>& b) noexcept {
  a.swap(b);
}
