...
template class graphlab::gl_vector<int>;
template class graphlab::gl_vector<gl_vector<int> >;
...
class gl_vector_datatype_test : public CxxTest::TestSuite {
...
class gl_vector_string_test : public CxxTest::TestSuite {

 public:

  void test_string_sanity() {
    gl_vector<std::string> v;
    TS_ASSERT_EQUALS(v.size(), 0);
    verify_consistency(v);
    verify_serialization(v);
  }
  ...
  void test_string_default_size_constructor() {
    ...
    gl_vector<std::string> c(n);
    TS_ASSERT(c.size() == n);

    for (typename gl_vector<std::string>::const_iterator i = c.cbegin(), e = c.cend(); i != e; ++i)
      TS_ASSERT(*i == typename gl_vector<std::string>::value_type());
  ...
  void test_string_fill_from_iterator() {
    ...
    test_iterator_fill<gl_vector<std::string> >(a, an);

    std::list<std::string> al(a, an);
    test_iterator_fill<gl_vector<std::string> >(al.begin(), al.end());
  }
  ...
  void test_string_erase() {
    const char* a1[] = {"1", "2", "3"};
    gl_vector<std::string> l1(a1, a1+3);
    gl_vector<std::string>::const_iterator i = l1.begin();
    ++i;
    gl_vector<std::string>::iterator j = l1.erase(i);
    TS_ASSERT_EQUALS(l1.size(), 2);
    TS_ASSERT_EQUALS(std::distance(l1.begin(), l1.end()), 2);
    TS_ASSERT_EQUALS(*j, "3");
    TS_ASSERT_EQUALS(*l1.begin(), "1");
  ...
  void test_string_erase_iter_iter() {
    ...
    {
      gl_vector<std::string> l1(a1, a1+3);
      gl_vector<std::string>::iterator i = l1.erase(l1.cbegin(), l1.cbegin());
      TS_ASSERT_EQUALS(l1.size(), 3);
      TS_ASSERT(std::distance(l1.cbegin(), l1.cend()) == 3);
      TS_ASSERT(i == l1.begin());
    ...
    {
      gl_vector<std::string> l1(a1, a1+3);
      gl_vector<std::string>::iterator i = l1.erase(l1.cbegin(), std::next(l1.cbegin()));
      TS_ASSERT_EQUALS(l1.size(), 2);
      TS_ASSERT_EQUALS(std::distance(l1.cbegin(), l1.cend()), 2);
      TS_ASSERT_EQUALS(i, l1.begin());
      TS_ASSERT(l1 == gl_vector<std::string>(a1+1, a1+3));
    ...
    {
      gl_vector<std::string> l1(a1, a1+3);
      gl_vector<std::string>::iterator i = l1.erase(l1.cbegin(), std::next(l1.cbegin(), 2));
      TS_ASSERT_EQUALS(l1.size(), 1);
      TS_ASSERT_EQUALS(std::distance(l1.cbegin(), l1.cend()), 1);
      TS_ASSERT(i == l1.begin());
      TS_ASSERT(l1 == gl_vector<std::string>(a1+2, a1+3));
      verify_consistency(l1);
      verify_serialization(l1);
    }
    {
      gl_vector<std::string> l1(a1, a1+3);
      gl_vector<std::string>::iterator i = l1.erase(l1.cbegin(), std::next(l1.cbegin(), 3));
      TS_ASSERT_EQUALS(l1.size(), 0);
      TS_ASSERT_EQUALS(std::distance(l1.cbegin(), l1.cend()), 0);
      TS_ASSERT(i == l1.begin());
      verify_consistency(l1);
    ...
    {
      gl_vector<gl_vector<std::string> > outer(2, gl_vector<std::string>(1));
      outer.erase(outer.begin(), outer.begin());
      TS_ASSERT_EQUALS(outer.size(), 2);
      TS_ASSERT_EQUALS(outer[0].size(), 1);
      TS_ASSERT_EQUALS(outer[1].size(), 1);
  ...
  void test_string_insert_initializer_list() {
    gl_vector<std::string> d(10, "1");
    gl_vector<std::string>::iterator i = d.insert(d.cbegin() + 2, {"3", "4", "5", "6"});
    TS_ASSERT(d.size() == 14);
    TS_ASSERT(i == d.begin() + 2);
    TS_ASSERT_EQUALS(d[0], "1");
    TS_ASSERT_EQUALS(d[1], "1");
  ...
  {
    gl_vector<std::string> v(100);
    int j;

    for (j = 0; j < 100; ++j)
      TS_ASSERT_EQUALS(v[j], "");

    gl_vector<std::string>::iterator i = v.insert(v.cbegin() + 10, "1");
  ...
  {
    gl_vector<std::string> v(100);
    gl_vector<std::string>::iterator i = v.insert(v.cbegin() + 10, 5, "1");
    TS_ASSERT_EQUALS(v.size(), 105);
    TS_ASSERT(i == v.begin() + 10);
    int j;
    for (j = 0; j < 10; ++j)
  ...
  void test_string_insert_by_iter()
  {
    ...
    gl_vector<std::string>::iterator i = v.insert(v.cbegin() + 10, (const char**)a, (const char**)(a + N));
  ...
  {
    gl_vector<std::string> v(100);
    gl_vector<std::string>::iterator i = v.insert(v.cbegin() + 10, "3");
  ...
  {
    gl_vector<std::string> v1(100);
    gl_vector<std::string> v2(200);

    std::string* ptr_1 = v1.data();
    std::string* ptr_2 = v2.data();
  ...
  void test_string_swap_2()
  {
    ...
    gl_vector<std::string> c1(a1, a1+sizeof(a1)/sizeof(a1[0]));
    gl_vector<std::string> c2(a2, a2+sizeof(a2)/sizeof(a2[0]));
    ...
    TS_ASSERT(c1 == gl_vector<std::string>(a2, a2+sizeof(a2)/sizeof(a2[0])));
    TS_ASSERT(c2 == gl_vector<std::string>(a1, a1+sizeof(a1)/sizeof(a1[0])));
  ...
  void test_string_shrink_to_fit_1()
  {
    ...
    v.push_back("1");
    v.shrink_to_fit();
    TS_ASSERT_EQUALS(v.capacity(), alignment_round<std::string>(101));
    TS_ASSERT_EQUALS(v.size(), 101);
  ...
  void test_string_resize_1()
  {
    ...
    TS_ASSERT(v.size() == 50);
    TS_ASSERT(v.capacity() == 100);
    TS_ASSERT(v == gl_vector<std::string>(50));
    v.resize(200, "1");
    TS_ASSERT(v.size() == 200);
    TS_ASSERT(v.capacity() >= 200);
    for (unsigned i = 0; i < 50; ++i)
  ...
  void test_string_assign_1() {
    gl_vector<std::string> l(3, "2");
    gl_vector<std::string> l2(2);
    l2 = l;
  ...
  void test_string_assign_3() {
    gl_vector<std::string> l(3, "2");
    gl_vector<std::string> l2(l.begin(), l.begin() + 2);
    l2 = l;
  ...
  void test_string_assign_move() {
    gl_vector<std::string> l;
    gl_vector<std::string> lo;

    for (int i = 1; i <= 3; ++i)
    {
      l.push_back(std::to_string(i));
      lo.push_back(std::to_string(i));
    }

    gl_vector<std::string> l2;
    l2 = std::move(l);
  ...
  void test_string_pop_back_2() {
    gl_vector<std::shared_ptr<std::string> > c;

    std::shared_ptr<std::string> i(new std::string("blob"));
  ...
  void test_string_string_serialization_2() {
    gl_vector<std::string> v(1000);

    for(size_t i = 0; i < v.size(); ++i) {
      v[i] = std::to_string(random_int());
    }
...
class gl_vector_types_test  : public CxxTest::TestSuite {
 public:
  void test_int() {
    _test_types<int>();
  }
...
class gl_vector_stress_test  : public CxxTest::TestSuite {
 ...
 public:
  ...
  void test_string() {
    random::seed(1);
    stress_test<std::string>(100000, []() { return std::to_string(random_int()); });
  }

  void test_vector() {
    random::seed(2);
    stress_test<std::vector<int> >(100000, []() {
